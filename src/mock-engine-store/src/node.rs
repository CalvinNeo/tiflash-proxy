...
pub struct NodeCluster {
    ...
    nodes: HashMap<u64, Node<TestPdClient, engine_tiflash::RocksEngine, engine_rocks::RocksEngine>>,
...
impl NodeCluster {
    ...
    pub fn post_create_coprocessor_host(
        &mut self,
        op: Box<dyn Fn(u64, &mut CoprocessorHost<engine_tiflash::RocksEngine>)>,
    ) {
...
impl Simulator<engine_tiflash::RocksEngine> for NodeCluster {
    fn run_node(
        &mut self,
        node_id: u64,
        cfg: Config,
