...
pub struct TiKVServer<ER: RaftEngine> {
    ...
    pub servers: Option<Servers<RocksEngine, ER>>,
    pub region_info_accessor: RegionInfoAccessor,
...
pub struct Servers<EK: KvEngine, ER: RaftEngine> {
...
pub trait ConfiguredRaftEngine: RaftEngine {
    ...
    fn as_rocks_engine(&self) -> Option<&engine_rocks::RocksEngine> {
        None
    }
...
pub struct EnginesResourceInfo {
    ...
    raft_engine: Option<engine_rocks::RocksEngine>,
...
impl EnginesResourceInfo {
    ...
    pub fn update(&self, _now: Instant) {
        ...
        for cf in &[CF_DEFAULT, CF_WRITE, CF_LOCK] {
            fetch_engine_cf_tiflash(&self.kv_engine, cf, &mut normalized_pending_bytes);
        }
        let (_, avg) = self
